...
class _IntroPage extends State<IntroPage> {
  ...
  Future<bool> _loginCheck() async {
    ...
    if(type == SignType.Email.name) {
      ...
      if(user != null) {
        CraftyUser craftyUser = CraftyUser(email: id, password: pw);
        craftyUser.type = SignType.Google.name;
        craftyUser.uid = user.uid;
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 20),
                          Lottie.asset('assets/animation/travel.json'),
                        ],
                      ),
                    ),
                  );
